...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///databaseDRA1.02.7.db'
...
class character(db.Model):
    ...
    user = db.relationship('userid', back_populates='character')
...
def Character():
    ...
    char = user.character  # Може бути None
    ...
    return render_template('Character.html', character=char, user=user)
